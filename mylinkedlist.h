 ...
 */
void freeStudent(student_cell_T*);
bool studentExists(linked_list_T* list,int  student);
int userSelect();
void doFunction(int,linked_list_T*);
void addStudent(linked_list_T*);
void printAllStudents(linked_list_T*);
void printData(linked_list_T*);
void findAndDeleteIndex(linked_list_T*);
int getIndex();
#endif